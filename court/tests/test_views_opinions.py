...
class OpinionModelTest(TestCase):
    ...
    def test_verdict_defended(self):
        ...
        Argument.objects.create(
            opinion=opinion, author=other1,
            side="DEF", content="defend"
        )
        Argument.objects.create(
            opinion=opinion, author=other2,
            side="DEF", content="defend2"
        )
    ...
    def test_verdict_prosecuted(self):
        ...
        Argument.objects.create(
            opinion=opinion, author=other1,
            side="PRO", content="prosecute"
        )
        Argument.objects.create(
            opinion=opinion, author=other2,
            side="PRO", content="prosecute2"
        )
